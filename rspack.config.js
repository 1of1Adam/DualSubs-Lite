...
export default defineConfig({
	entry: {
		...
		// "External.Lyrics.response": "./src/External.Lyrics.response.js",  // 需要 protobuf (YouTube/Spotify 歌词)
		"Manifest.response": "./src/Manifest.response.js",
		"Translate.response": "./src/Translate.response.js",  // 已移除 YouTube/Spotify protobuf 依赖
	},
	output: {
		chunkFormat: false,
